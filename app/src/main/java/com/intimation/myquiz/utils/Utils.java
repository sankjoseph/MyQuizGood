...
public class Utils {
    ...
    //public static final String URL_VIEW_QUESTION = " http://www.entekrishi.com/mobile/login/?username=kirankrishnan@axtecindia.com&password=kiran123&device=mydeviceId";
